    ...
    <div>
      ...
      <div className=" flex flex-row items-center justify-between  text-white py-3">
        ...
        <div className="flex flex-col space-y-2">
          <div className=" flex font-light text-sm items-center justify-center">
            ...
            Real fell:
            <span className=" ml-1 font-bold">{`${feels_like.toFixed()}`}&deg;</span>
          </div>
          <div className=" flex font-light text-sm items-center justify-center">
            <UilTear size={18} className=" mr-1" />
            Humidity:
            <span className=" ml-1 font-bold">{`${humidity.toFixed()}`}%</span>
          </div>
          <div className=" flex font-light text-sm items-center justify-center">
            <UilWind size={18} className=" mr-1" />
            Wind:
            <span className=" ml-1 font-bold">{`${speed.toFixed()}`}km/h</span>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <p className=" font-light ">
          Rise: <span className=" font-bold ml-1">{fromatToLocalTime(sunrise, timezone, 'hh:mm a')}</span>
        </p>
